 ...
 */
//c & c++
int LANG_CV[256] = {0, 1, 2, 3, 4, 5, 8, 9, 11, 12, 20, 21, 59, 63, 89, 158, 231, 240, 272, 511, SYS_time, SYS_read, SYS_uname, SYS_write, SYS_open,
...
//ruby
int LANG_RV[256] = {0, 1, 2, 3, 4, 5, 9, 10, 12, 13, 14, 16, 21, 22, 56, 59, 72, 97, 98, 107, 108, 131, 158, 202, 218, 231, 273, 96, 340, 4, 126, SYS_access, SYS_arch_prctl, SYS_brk,
...
//c-sharp
int LANG_CSV[256] = {0, 39, 157, 302, 1, 2, 3, 4, 5, 8, 9, 10, 11, 12, 13, 14, 16, 21, 24, 41, 42, 56, 59, 63, 72, 78, 79, 89, 97, 102, 131, 137, 158, 202, 204, 218, 229, 231, 234, 257, 273, 257, 141, 95, 64, 65, 66, 83, 24, 42, 41, 158, 117, 60,
...
//go-lang
int LANG_GOV[256] = {0, 1, 9, 11, 13, 14, 56, 59, 131, 158, 186, 202, 204, 228, 231, 267, 0};
