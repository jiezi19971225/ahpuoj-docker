...
//java
int LANG_JV[256] = {3, 6, 11, 20, 33, 45, 85, 91, 120, 122, 125, 174, 175, 191, 192, 195, 197, 240, 243, 252, 258, 295, 311, SYS_fcntl64, SYS_getdents64, SYS_ugetrlimit,
...
int LANG_OV[256] = {3, 221, 102, 191, SYS_access, SYS_brk, SYS_close, SYS_execve,
					...
					SYS_write, 0};
//freebasic
int LANG_BASICV[256] = {3, 4, 5, 6, 11, 33, 45, 54, 91, 101, 122, 125, 140, 174, 175, 191, 192, 195, 197, 240, 243, 252, 258, 311, 330, SYS_access, SYS_brk, SYS_close, SYS_execve,
...
//go-lang
int LANG_GOV[256] = {3, 4, 11, 120, 123, 174, 175, 186, 192, 240, 242, 252, 265, 267, 0};
