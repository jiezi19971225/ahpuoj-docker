...
<link rel="stylesheet" href="<?php echo $path_fix ?>template/<?php echo $OJ_TEMPLATE ?>/css/ahpu.css">
<link rel="stylesheet" href="<?php echo $path_fix ?>template/<?php echo $OJ_TEMPLATE ?>/css/reset.css">
