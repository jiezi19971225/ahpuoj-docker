		...
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			...
			if (ra[0] < 4) {
				...
				switch (ra[0]) {
					case "6":
					case "10":
						row.cells[3].innerHTML = "<a href='reinfo.php?sid=" + solution_id + "' class='" + judge_color[ra[0]] + " noradius btn-sm'>" + judge_result[ra[0]] + "</a>";
						break;
					case "11":
						row.cells[3].innerHTML = "<a href='ceinfo.php?sid=" + solution_id + "' class='" + judge_color[ra[0]] + " noradius btn-sm'>" + judge_result[ra[0]] + "</a>";
						break;

					default:
						row.cells[3].innerHTML = "<span class='" + judge_color[ra[0]] + " noradius btn-sm'>" + judge_result[ra[0]] + "</span>";
				}
				auto_refresh();
