    ...
    <div class="general-form-wrapper">
      <div class="row">
        <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
          <form action="contest.php" class="form-inline">
    ...
    <table class='table table-striped'>
      <thead>
        <tr class="toprow">
          ...
          <td style="width:15%;">包含竞赛&作业总数</td>
        </tr>
      </thead>
      <tbody>
        <?php
...
for ($i = $start; $i <= $end; $i++) {
    echo "<li class='" . ($page == $i ? "active " : "") . "page-item'>
            <a title='go to page' href='series.php?page=" . $i . "'>" . $i . "</a></li>";
}
?>
        <li class="page-item">
          <a href="series.php?page=<?php echo $total_page ?>">&gt;&gt;</a>
        </li>
    </ul>
  </div>
