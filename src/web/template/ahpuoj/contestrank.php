...
<head>
  ...
  <title>竞赛&作业排名 -- <?php echo $title ?></title>
...
<body>
  ...
  <div class="main-content">
    <div style="text-align:center;">
      <h3>竞赛&作业排名 -- <?php echo $title ?></h3>
      <a class='btn btn-sm btn-info noradius' href="contestrank.xls.php?cid=<?php echo $contest_id ?>">导出Excel文件</a>
    </div>
    <?php
$rank = 1;
if ($OJ_MEMCACHE) {
        ...
        <table id="rank" class="table table-striped" width="95%">
          <thead>
            <tr class="toprow">
              ...
              <th style="width:120px; min-width: 120px;">用户</th>
              <th style="width:120px; min-width: 120px;">昵称</th>
              <?php if ($team_mode) {
    echo "<th style='width:120px; min-width: 120px;'>团队</th>";
}?>
              <th style="width:60px; min-width: 60px;">通过</th>
...
for ($i = 0; $i < $user_cnt; $i++) {
    ...
    if ($team_mode) {
        echo "<th style='width:120px; min-width: 120px;'>$team_name</th>";
    }
    echo "<td><a href=status.php?user_id=$uuid&cid=$contest_id>$usolved</a>";
