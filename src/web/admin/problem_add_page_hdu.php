          ...
          <div class="panel-body">
            <form method="POST" action="problem_add.php" class="layui-form">
              <div class="form-group">
                ...
                <input class="form-control" style="width:30%;" type="text" name="title" id="title" value="<?php echo isset($title) ? $title : '' ?>" placeholder="请输入问题标题" lay-verify="required">
              </div>
              <div class="form-group">
